...
<div class="signin-password-label">Пароль:</div>
    <input class="signin-password"
        ...
        required 
        aria-label="Пароль" />
<button class="signin-button" on:click={login} aria-label="Войти">Войти</button>
</div>
...
<div class="login-password-label">Пароль:</div>
    <input class="login-password"
        ...
        required 
        aria-label="Пароль" />
<button class="login-button" on:click={register} aria-label="Зарегистрироваться">Зарегистрироваться</button>
</div>
